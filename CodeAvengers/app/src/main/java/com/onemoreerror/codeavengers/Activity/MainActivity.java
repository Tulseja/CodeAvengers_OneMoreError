package com.onemoreerror.codeavengers.Activity;
...
import com.onemoreerror.codeavengers.R;
...
import static com.onemoreerror.codeavengers.Constants.AppConstants.SCANNER_CODES.MY_SCAN_REQUEST_CODE;
...
public class MainActivity extends AppCompatActivity implements SpeechDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TODO : Decalre AppApplication in manifest and do this init there.
        Speech.init(this);
    ...
    public void onScanPressed(View v){
        Intent scanIntent = new Intent(this, CardIOActivity.class);
        Log.e("AK", "button pressed");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == MY_SCAN_REQUEST_CODE) {
            ...
            // do something with resultDisplayStr, maybe display it in a textView
             textToSpeech.setText(resultDisplayStr);
        }
